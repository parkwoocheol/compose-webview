...
actual open class ComposeWebChromeClient {
    ...
    internal var onPermissionRequestCallback: ((PlatformPermissionRequest) -> Unit)? = null
    ...
    internal actual fun setOnPermissionRequestHandler(handler: (PlatformPermissionRequest) -> Unit) {
